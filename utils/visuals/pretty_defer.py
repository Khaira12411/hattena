...
async def pretty_defer(
    ...
    content: str = "Please wait while Hattena thinks...",
    embed: discord.Embed | None = None,
    ephemeral: bool = True,
):
    """
    Fully safe Hattena loader for interactions.
...
async def pretty_error(
    ...
    """
    Standalone ephemeral error sender for Hattena.
    - Always ephemeral.
    - Uses Hattena's error emoji.
